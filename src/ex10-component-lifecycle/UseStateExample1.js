    ...
    const Form = () => {
        ...
        return(
            <div> 
                  <form>
                    <div className='mb-3'>
                        <input type="text" value = {person.firstName} onChange={(e) => onInputChange(e, 'firstName')} className='form-control' id='firstName' name='firstName' placeholder='Enter your first name..' />
                        <span className='text-danger'>{errorForm.firstName}</span>
                    </div>

                    <div className='mb-3'>
                        <input type="text" value = {person.lastName}  onChange={(e) =>onInputChange(e, 'lastName')} className='form-control' id='lastName' name='lastName' placeholder='Enter your last name..' />
                        <span className='text-danger'>{errorForm.lastName}</span>
                    </div>

                    <div className='mb-3'>
                        <button type='button' className='btn btn-info'  onClick={clickHandler}>Click Me</button>
                        </div>
                </form>
                <br />
                 </div>
